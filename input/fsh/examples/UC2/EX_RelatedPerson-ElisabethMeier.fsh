Instance: RelatedPerson-ElisabethMeier
InstanceOf: ChEmrRelatedPerson
Usage: #example
Title: "Elisabeth Meier - Ehefrau"
Description: "Ehefrau von Hans Meier als Notfallkontakt"

* active = true
* patient = Reference(Patient-HansMeier)
