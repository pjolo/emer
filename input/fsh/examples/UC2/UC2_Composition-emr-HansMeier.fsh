...
* section[0].entry[0] = Reference(UC2-Patient-HansMeier)
* section[0].entry[1] = Reference(UC2-RelatedPerson-ElisabethMeier)
...
* section[1].entry = Reference(UC2-Condition-Vorhofflimmern)
