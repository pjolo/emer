...
// Diabetes Condition
* entry[3].fullUrl = "http://fhir.ch/ig/emr/Condition/UC1-Condition-Diabetes"
* entry[3].resource = UC1-Condition-Diabetes

// Metformin Medication
* entry[4].fullUrl = "http://fhir.ch/ig/emr/MedicationStatement/UC1-MedicationStatement-Metformin"
* entry[4].resource = UC1-MedicationStatement-Metformin

// Penicillin Allergie
* entry[5].fullUrl = "http://fhir.ch/ig/emr/AllergyIntolerance/UC1-AllergyIntolerance-Penicillin"
* entry[5].resource = UC1-AllergyIntolerance-Penicillin

// HbA1c Observation
* entry[6].fullUrl = "http://fhir.ch/ig/emr/Observation/UC1-Observation-HbA1c"
* entry[6].resource = UC1-Observation-HbA1c

// RelatedPersons
* entry[7].fullUrl = "http://fhir.ch/ig/emr/RelatedPerson/UC1-RelatedPerson-PeterSchmidt"
* entry[7].resource = UC1-RelatedPerson-PeterSchmidt

* entry[8].fullUrl = "http://fhir.ch/ig/emr/RelatedPerson/UC1-RelatedPerson-AnnaMueller"
