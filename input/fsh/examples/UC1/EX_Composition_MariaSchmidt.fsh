...
* section[0].entry[0] = Reference(Patient-MariaSchmidt)
* section[0].entry[1] = Reference(RelatedPerson-PeterSchmidt)
* section[0].entry[2] = Reference(RelatedPerson-AnnaMueller)
...
* section[1].entry = Reference(Condition-Diabetes)
...
* section[3].entry = Reference(AllergyIntolerance-Penicillin)
...
* section[4].entry = Reference(Observation-HbA1c)
...
* section[6].entry = Reference(Practitioner-DrMueller)
