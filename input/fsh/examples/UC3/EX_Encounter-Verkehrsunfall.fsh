Instance: Encounter-Verkehrsunfall
...
* participant[0].individual = Reference(Practitioner-DrNotarzt)

* participant[1].type = http://terminology.hl7.org/CodeSystem/v3-ParticipationType#CON
* participant[1].individual = Reference(Practitioner-DrGynaekologin)
