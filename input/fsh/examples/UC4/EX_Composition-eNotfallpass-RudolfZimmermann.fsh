Instance: Composition-eNotfallpass-RudolfZimmermann
...
* confidentiality = #N
* custodian = Reference(Organization-Hausarztpraxis-DrWeber)
...
* section[0].entry[0] = Reference(Patient-RudolfZimmermann)
* section[0].entry[1] = Reference(RelatedPerson-ElisabethZimmermann)
...
* section[1].entry[0] = Reference(Condition-HeartFailure)
* section[1].entry[1] = Reference(Condition-AtrialFibrillation)
* section[1].entry[2] = Reference(Condition-ChronicKidneyDisease)
* section[1].entry[3] = Reference(Condition-DiabetesRudolf)
...
* section[2].entry[0] = Reference(MedicationStatement-Ramipril)
* section[2].entry[1] = Reference(MedicationStatement-Metoprolol)
* section[2].entry[2] = Reference(MedicationStatement-Furosemid)
* section[2].entry[3] = Reference(MedicationStatement-MetforminRudolf)
...
* section[3].entry = Reference(Observation-CreatinineLevel)
...
* section[4].entry = Reference(Device-HipProsthesis)
...
* section[5].entry = Reference(Consent-MedicalPowerOfAttorney)
...
* section[6].entry = Reference(Practitioner-DrWeber)
